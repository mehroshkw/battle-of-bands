...
class MaterialDialogHelper {
  ...
  void showVoteDialogue(
      {String? title,
      Function? positiveClickListener,
      Function? negativeClickListener}) {
    final context = _context;
    if (context == null) return;
    showDialog(
        ...
        builder: (_) {
          return WillPopScope(
              child: AlertDialog(
                  ...
                  contentPadding: const EdgeInsets.only(bottom: 0),
                  backgroundColor:
                      Constants.colorPrimaryVariant.withOpacity(0.9),
                  shape: const RoundedRectangleBorder(
                      borderRadius: BorderRadius.all(Radius.circular(16))),
                  content: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(color: Constants.scaffoldColor)),
                    child: Column(
                        mainAxisSize: MainAxisSize.min,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
  ...
  void showLogOutDialogue(
      {Function? positiveClickListener, Function? negativeClickListener}) {
    final context = _context;
    if (context == null) return;
    showDialog(
        context: context,
