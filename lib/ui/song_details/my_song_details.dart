              ...
              children: [
                Column(children: [
                  Container(
                      ...
                      child: Text(bloc.song[index].genre.title, style: const TextStyle(fontFamily: Constants.montserratRegular, color: Constants.colorPrimary, fontSize: 18))),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                    IconButton(
                        ...
                        icon: Image.asset('assets/3x/previous.png', height: 20, width: 20)),
                    IconButton(
                        splashRadius: 30.0,
                        splashColor: Constants.colorPrimary,
