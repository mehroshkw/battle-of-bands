              ...
              child: BlocBuilder<MySongDetailsBloc, MySongDetailsState>(builder: (_, state) {
                ...
                return Column(children: [
                  Container(
                      ...
                      child: Text(
                        bloc.song[index].genre.title,
                        style: const TextStyle(fontFamily: Constants.montserratRegular, color: Constants.colorPrimary, fontSize: 18),
                      )),
                  const SizedBox(
                    height: 20,
                  ),
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          String url = "$BASE_URL_IMAGE/${bloc.song[index].fileUrl}";
                  ...
                  Text(
                    bloc.song[index].title,
                    textAlign: TextAlign.left,
                    style: const TextStyle(fontFamily: Constants.montserratSemibold, fontSize: 28, color: Constants.colorOnPrimary),
                  ),
                  Padding(
                      ...
                      child: Text(
                        ...
                        textAlign: TextAlign.left,
                        style: const TextStyle(fontFamily: Constants.montserratLight, fontSize: 20, color: Constants.colorText),
                      )),
                  Padding(
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign.left,
                      style: const TextStyle(fontFamily: Constants.montserratRegular, fontSize: 16, color: Constants.colorPrimary),
                    ),
                  ),
                  Slider(
                  ...
                  Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        BlocBuilder<MySongDetailsBloc, MySongDetailsState>(
                            buildWhen: (previous, current) => previous.currentDuration != current.currentDuration,
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                    GestureDetector(onTap: () => bloc.playNextSong(), child: Image.asset('assets/3x/previous.png', height: 20, width: 20)),
                    GestureDetector(onTap: () => bloc.backwardTenSeconds(), child: Image.asset('assets/3x/back.png', height: 20, width: 20)),
                    BlocBuilder<MySongDetailsBloc, MySongDetailsState>(
                    ...
                    GestureDetector(onTap: () => bloc.forwardTenSeconds(), child: Image.asset('assets/3x/forward.png', height: 20, width: 20)),
                    GestureDetector(
                      onTap: () => bloc.playPreviousSong(),
                      child: Image.asset('assets/3x/next.png', height: 20, width: 20),
                    )
                  ])
                ]);
              })),
