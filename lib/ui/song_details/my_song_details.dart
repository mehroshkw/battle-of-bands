                    ...
                    builder: (_, state) {
                      ...
                      return Column(children: [
                        Container(
                            ...
                            child: Text(
                                bloc.song[index].genre.title, style: const TextStyle(fontFamily: Constants.montserratRegular, color: Constants.colorPrimary, fontSize: 18))),
                        ...
                        Padding(
                            ...
                            child: Text('${AppText.VOTE} ${bloc.song[index].votesCount}',
                                textAlign: TextAlign.left, style: const TextStyle(fontFamily: Constants.montserratRegular, fontSize: 16, color: Constants.colorPrimary))),
                        Slider(
                        ...
                        Padding(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              BlocBuilder<MySongDetailsBloc, MySongDetailsState>(
                                  ...
                                  builder: (_, state) =>
                                      Text(bloc.formatDuration(state.currentDuration.inSeconds),
                                          style: TextStyle(
                                            fontFamily: Constants.montserratLight,
                                            color: Constants.colorOnSurface.withOpacity(0.7),
                                          ))),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                          GestureDetector(onTap: () => bloc.playPreviousSong(), child: Image.asset('assets/3x/previous.png', height: 20, width: 20)),
                              ...
                              builder: (_, state) =>
                                  GestureDetector(
                                      ...
                                      child: state.isPlaying
                                          ...
                                          width: 60,
                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(100), color: Constants.colorPrimary),
                                          child: const Icon(Icons.play_arrow_rounded, size: 50, color: Constants.colorOnSurface)))),
                          GestureDetector(onTap: () => bloc.forwardTenSeconds(), child: Image.asset('assets/3x/forward.png', height: 20, width: 20)),
                          GestureDetector(onTap: () => bloc.playNextSong(), child: Image.asset('assets/3x/next.png', height: 20, width: 20))
                        ])
                      ]);
                    }))
        ));
