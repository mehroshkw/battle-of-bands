              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          print("$BASE_URL_IMAGE/${bloc.song[index].fileUrl}");
                          String url =
                              "$BASE_URL_IMAGE/${bloc.song[index].fileUrl}";
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        bloc.formatDuration(bloc.song[index].duration.toInt()),
                        style: TextStyle(
                          fontFamily: Constants.montserratLight,
                          color: Constants.colorOnSurface.withOpacity(0.7),
                        ),
