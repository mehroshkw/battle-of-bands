        ...
        body: SingleChildScrollView(
            ...
            child: Column(children: [
                            ...
                            : Column(children: [
                                Padding(
                                    ...
                                    child: Text(AppText.UPLOAD_DESCRIPTION,
                                        ...
                                        style: TextStyle(
                                            fontFamily: Constants.montserratBold, color: Constants.colorOnSurface.withOpacity(0.6), fontSize: 14))),
                                Container(
              ...
              SizedBox(
                  width: size.width,
                  height: 70,
                  child: AppTextField(hint: AppText.URL, controller: bloc.urlController, textInputType: TextInputType.emailAddress, isError: false)),
              BlocBuilder<UploadSongBloc, UploadSongState>(
