...
class _MainScreenState extends State<MainScreen> {
  ...
  static const _battleScreenNavigationKey =
      PageStorageKey(BattleScreen.key_title);
  static const _allSongsKeyNavigationKey =
      PageStorageKey(AllSongsScreen.key_title);
  ...
  void initState() {
    ...
    _bottomMap[_battleScreenNavigationKey] =
        const BattleScreen(key: _battleScreenNavigationKey);
    _bottomMap[_allSongsKeyNavigationKey] =
        const AllSongsScreen(key: _allSongsKeyNavigationKey);
