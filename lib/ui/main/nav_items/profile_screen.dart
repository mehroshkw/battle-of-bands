        ...
        appBar: AppBar(
            ...
            actions: [
              GestureDetector(
                  onTap: () async {
                    final result =
                        await Navigator.pushNamed(context, EditProfile.route);
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            BlocBuilder<MainScreenBloc, MainScreenState>(
                                ...
                                builder: (_, state) => Text(state.userEmail,
                                    style: const TextStyle(
                                        fontSize: 14,
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            BlocBuilder<MainScreenBloc, MainScreenState>(
                                buildWhen: (previous, current) =>
                                    previous.userDb != current.userDb,
                                builder: (_, state) => Text(state.userDb,
                                    style: const TextStyle(
                                        fontSize: 14,
                                        fontFamily: Constants.montserratLight,
                                        color: Constants.colorText)))
                      ...
                      Row(children: [
                        GestureDetector(
                            ...
                            child: const Text(AppText.CHANGE_PASSORD,
                                style: TextStyle(
                                    fontSize: 18,
                                    fontFamily: Constants.montserratRegular,
                                    color: Constants.colorPrimary)))
