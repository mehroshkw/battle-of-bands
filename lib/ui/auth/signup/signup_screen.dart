...
class SignupScreen extends StatelessWidget {
  ...
  Future<void> _signup(SignupBloc bloc, BuildContext context, MaterialDialogHelper dialogHelper) async {
    dialogHelper
    ...
    try {
      ...
      snackbarHelper.showSnackbar(snackbar: SnackbarMessage.success(message: AppText.ACCOUNT_CREATED_SUCCESSFULLY));
      Future.delayed(const Duration(seconds: 1)).then((_) =>
          Navigator.pushNamedAndRemoveUntil(context, MainScreen.route, (route) => false));
    } catch (_) {
      dialogHelper.dismissProgress();
      dialogHelper.showMaterialDialogWithContent(MaterialDialogContent.networkError(), () => _signup(bloc, context, dialogHelper));
    }
  }
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                        ...
                        Text(state.errorText,
                            style: const TextStyle(
                                color: Constants.colorError, fontFamily: Constants.montserratRegular, fontSize: 12))
                      ]));
                }),
                ...
                onClick: () {
                  ...
                  if (bloc
                    ...
                    bloc.updateConfirmPasswordError(
                        true,
                        AppText
                            .CONFIRM_PASSWORD_FIELD_CANNOT_BE_EMPTY);
                    return;
                  }
                  // if (bloc.confirmPasswordController != bloc.newPassword) {
                  //   bloc.updateConfirmPasswordError(true, AppText.PASSWORD_AND_CONFIRM_PASSWORD_NOT_MATCH);
                  //   return;
                  // }
