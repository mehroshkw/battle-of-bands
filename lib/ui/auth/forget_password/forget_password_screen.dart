...
class ForgetPasswordScreen extends StatelessWidget {
  ...
  Future<void> _forgetPassword(ForgetPasswordBloc bloc, BuildContext context, MaterialDialogHelper dialogHelper) async {
    dialogHelper
    ...
    try {
      ...
      snackbarHelper.showSnackbar(snackbar: SnackbarMessage.success(message: AppText.EMAIL_SENT));
      Future.delayed(const Duration(seconds: 1)).then((_) =>
          Navigator.pop(context));
    } catch (_) {
      dialogHelper.dismissProgress();
      dialogHelper.showMaterialDialogWithContent(MaterialDialogContent.networkError(), () => _forgetPassword(bloc, context, dialogHelper));
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: 50,
              width: size.width,
              child: AppButton(text: AppText.SEND,
                onClick: (){
                  ...
                  _forgetPassword(bloc, context, MaterialDialogHelper.instance());
              },
                color: Constants.colorPrimary,),
            ),
          ],
